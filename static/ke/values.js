export default [
  {
    ...
    description:
      "When you trust us with a service, we deliver. Whether it's food, laundry, beauty or cleaning, there are no buts, no ifs. Just done. Damaged items get replaced.",
    shadow: true,
    background: '#FFFFFF',
    layout: 'row',
    button: 'modal',
    ...
    media: {
      type: 'image',
      src:
        'https://res.cloudinary.com/eden-life-inc/image/upload/v1663862868/eden-website-v2/KE_Staff_ran0ft.png',
      size: 'large',
    },
  ...
  },
  {
    ...
    modal_testimonial: {
      ...
      image: 'lead-kofo',
      description:
        "To all my fellow bachelors (forever) get yourself an <span style='color:#03A84E'> @ouredenlife </span> subscription to give yourself more time for the other pleasures of life.",
      tweetLink:
  ...
  },
  {
    ...
    modal_testimonial: {
      ...
      image: 'lead-tabitha',
      description:
        "Moments at the Garden of <span style='color:#03A84E'>@ouredenlife_ke 💚</span> @ouredenlife_ke 💚 - The Concierge of Comfort. <br/> Dear Devs in Kenya, let Eden Life take care of you as you focus on solving other problems. You will love it!",
      tweetLink:
        'https://twitter.com/tabithakavyu/status/1520659085816905728?s=21&t=yprD-SSSrRF8UBCWdgUofg',
    },
    modal_form: false,
  },
  {
    ...
    modal_testimonial: {
      ...
      image: 'lead-charles',
      description:
        "Single people in Nairobi with limited free time.<span style='color:#03A84E'> @ouredenlife_ke</span>. are here and after the first week of usage, I would highly recommend. Give them your monies. ",
      tweetLink:
        'https://twitter.com/gich99/status/1504104313936879621',
    },
    modal_form: true,
  ...
  },
  {
    ...
    modal_testimonial: {
      name: 'Funmi Oyatogun',
      handle: '@funmioyatogun',
      image: 'lead-funmi',
      description:
        "I highly recommend <span style='color:#03A84E'>@ouredenlife</span> And they are a lot more affordable than people realize. Let them do what they do best, so you can use your time for other productive things and joys.",
      tweetLink:
  ...
  },
  {
    ...
    modal_testimonial: {
      ...
      image: 'lead-nicelegs',
      description:
        "Working on projects while <span style='color:#03A84E'>@ouredenlife</span> does the chores, talk about maximum productivity >>>>>>>>>>>>>> <br><br> Please I'm not lazy I just don't like stress besides it's called delegating for a reason 😁",
      tweetLink:
  ...
  },
  {
    ...
    modal_testimonial: {
      ...
      image: 'lead-presly',
      description:
        "Touchdown Nairobi, and I had to replug my <span style='color:#03A84E'>@ouredenlife_ke</span> meal plan immediately. Ain’t got time to worry about food when I know  <span style='color:#03A84E'>@ouredenlife</span>got me! 💪🏿They got me in Lagos, why not Nairobi. 💚",
      tweetLink: 'https://twitter.com/pr_sl_y/status/1526840952043847681',
    },
    modal_form: true,
    cta: 'Enjoy Quality Service',
    form_type: 'individual',
  },
  {
    ...
    modal_testimonial: {
      ...
      image: 'lead-adora',
      description:
        " I have multiple anons on this app yo! <br>Just got another <span style='color:#03A84E'>@ouredenlife</span> carebox delivered to me ♥️♥️. <br>Thank you 😩",
      tweetLink:
  ...
  },
  {
    ...
    modal_testimonial: {
      ...
      image: 'lead-ibukun',
      description:
        'Did one week of Eden and inches have literally melted off my waist and hips',
      tweetLink:
...

  {
    ...
    modal_testimonial: {
      ...
      image: 'lead-awonowo',
      description:
        "<span style='color:#03A84E'>@ouredenlife</span> is probably the most reliable vendor we worked with in 2020 @MicdeeDesigns <br><br> One of the few companies that my people didn’t come back to complain about their service. And we work with a lot of vendors.<br><br>They really have something good going and I’m rooting for them.",
