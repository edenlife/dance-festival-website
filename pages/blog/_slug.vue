<template>
  <div v-if="postDetails" class="container">
    <div
    ...
    <div class="container--content" id="main-article-content">
      <div class="content">
        <div class="content__social fixed hide" id="social-content">
          ...
          >
            <svg
              ...
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              @click.prevent="openSocialMedia('Email')"
            >
              <path
        ...
        <div class="content__social mobile" id="social-content">
          <p class="content__social-title">Share</p>
          <ShareNetwork
            network="twitter"
...
export default {
  ...
  methods: {
    ...
    handleScroll() {
      ...
      const minBreakpoint = 800
      const maxHeight = mainArticleContent.clientHeight + 500
      if (
    ...
    openSocialMedia(name) {
      mixpanelTrackEvent(
        `${name} share icon clicked - ${this.article.title.rendered}`
      )
    },
    getCategory(id) {
