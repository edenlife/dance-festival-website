  ...
  data() {
    return {
      ...
      extraLaundryCost: [
        ...
        { item: 'Big size towel (2 items)', cost: '2466' },
        { item: 'Bedsheet (3 items)', cost: '3699' },
        { item: 'Blanket (3 items)', cost: '3699' },
        { item: 'A pair of suit (4 items)', cost: '4930' },
        { item: '3 piece Agbada (5 items) ', cost: '6165' },
        { item: 'Curtain (8 items)', cost: '9865' },
        { item: 'Duvet (10 items)', cost: '12330' },
      ],
      extraLaundryCostWashDry: [
        { item: 'Extra item', cost: '967' },
        { item: 'Jacket (2 items)', cost: '1935' },
        { item: 'Big size towel (2 items)', cost: '1935' },
        { item: 'Bedsheet (3 items)', cost: '2900' },
        { item: 'Blanket (3 items)', cost: '2900' },
        { item: 'A pair of suit (4 items)', cost: '3868' },
        { item: '3 piece Agbada (5 items) ', cost: '4835' },
        { item: 'Curtain (8 items)', cost: '7736' },
        { item: 'Duvet (10 items)', cost: '9670' },
      ],
    }
  },
  head() {
