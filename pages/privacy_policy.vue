...
export default {
  data() {
    return {
      ...
      tabs: privacy,
      content:
        'The Privacy Policy states how we,  Eden Life, Inc. (the “Company”) use your data when you use the services available through our website located at https://ouredenlife.com',
    }
  },
  head() {
    return {
